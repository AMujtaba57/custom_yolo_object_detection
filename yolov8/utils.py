...
class_names = ["Flute", "Guitar", "Drum", "Piano", "Saxophone", "Trumpet", "Watercraft", "Rose", "Houseplant",
...
def draw_box( image: np.ndarray, box: np.ndarray, color: (int, int, int) = (0, 0, 255),
